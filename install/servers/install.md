To run all required server needs to execute docker compose file
...
To run the kafka producer and consumer and creating the topics and groups with partitioning
